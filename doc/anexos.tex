...
% Datos de portada
\title{Sky Classification through Supervised Machine Learning \\Technical Documentation}
...
\include{./tex/D_Programmer_Manual}
\include{./tex/E_User_Manual}
\include{./tex/F_Curricular_Sustainability_Annex}


\bibliographystyle{plain}
\bibliography{bibliographyAnexos}
